...
import { Card, Row, Col, Spin, Empty, Button, Space, Typography, Pagination, Input, Slider, Select, Modal  } from 'antd';
...
const HomePage = () => {
  ...
  const handleViewDetail = async (product) => {
    try {
      // Ghi nhận lượt xem
      await recordProductViewApi(product._id);
      ...
      >
        {selectedProduct && (
          <div>
            ...
            <p>Mô tả: {selectedProduct.description || "Không có mô tả"}</p>
            <p>Lượt xem: {selectedProduct.views || 0}</p>
          </div>
        )}
      </Modal>
    </div>
